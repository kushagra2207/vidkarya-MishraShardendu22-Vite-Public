...
const InternshipForm = ({ onInternshipCreated }) => {
    ...
    <div className="notes-form-section">
      <div className="container">
        <div className="notes-form-main-navbar">
          <h1 className="notes-form-heading">Create an Internship</h1>
          <span className="notes-form-cross-sign" onClick={onInternshipCreated}>
            ×
          </span>
        </div>
        <form onSubmit={createInternship} className="notes-form-allInput">
          ...
          <div className="notes-form-classInput">
            <div className="notes-form-input-labels">Stipend</div>
            <input
              type="text"
          ...
          <div className="btn_container">
            ...
            <button type="button" className="cancleBtn" onClick={onInternshipCreated}>
              Cancel
            </button>
          </div>
        </form>
